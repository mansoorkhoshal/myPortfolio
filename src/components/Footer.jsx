...
export const Footer = () => {
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "mansoorahmad.dev44@gmail.com", href: "mailto:mansoorahmad.dev44@gmail.com.com" },
    { icon: <Phone size={16} />, text: "+92 3234466448", href: "tel:+923234466448" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">MANSOOR</h3>
          ...
          >
            <div>
              <p>© {currentYear} Mansoor. All rights reserved.</p>
            </div>
